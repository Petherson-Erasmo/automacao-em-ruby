...
Quando('submeto minhas credenciais com {string} e {string}') do |email, password|
    ...
    # # Na classe LoginPage programamos para encontrar o campo email, agora basta chamar o método e informar o valor que queremos.
    # @login_page.campo_email.set email
    # # Na classe LoginPage programamos para encontrar o campo senha, agora basta chamar o método e informar o valor que queremos.
    # @login_page.campo_senha.set password
    # # Na classe LoginPage programamos para clicar no botão, agora basta chamar o método.
